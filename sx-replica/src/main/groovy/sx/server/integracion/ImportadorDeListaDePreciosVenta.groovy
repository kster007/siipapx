 ...
 */
@Component
class ImportadorDeListaDePreciosVenta implements Importador {
    ...
    def importarPartidas(ListaDePreciosVenta lista){
        ...
        partidas.each{ row ->
            ...
            if(!producto ){
                producto = importadorDeProductos.importar()
            }
    ...
    static String QUERY_PARTIDAS ="""
        select
            ...
            l.prov_clave as proveedorClave,
            l.prov_nombre as proveedorNombre,
            l.kilos,
            l.gramos,
            l.*
